...
const countXs = (s) => {
  let xstring = s.substring(s.search(/[abcddefghijklmnopqrstuvwyz]/),s.search(/[abcddefghijklmnopqrstuvwyz]/)+s.search(/[abcddefghijklmnopqrstuvwyz]/)+s.search(/[abcddefghijklmnopqrstuvwyz]/)+s.search(/[abcddefghijklmnopqrstuvwyz]/)+s.search(/[abcddefghijklmnopqrstuvwyz]/)+s.search(/[abcddefghijklmnopqrstuvwyz]/)+s.search(/[abcddefghijklmnopqrstuvwyz]/))
